...
describe ArticlesController, "redirecting" do
  ...
  describe 'accessing old-style URL with "articles" as the first part' do
    it 'should redirect to article' do
      ...
      assert_response 301
      response.should redirect_to("http://myblog.net/2004/04/01/search-target")
    end
    ...
    it 'should redirect to article with url_root' do
      ...
      get :redirect, :from => ["articles", "2004", "04", "01", "search-target"]
      assert_response 301
      response.should redirect_to("http://test.host/blog/2004/04/01/search-target")
    end
    ...
    it 'should redirect to article when url_root is articles' do
      ...
      get :redirect, :from => ["articles", "2004", "04", "01", "search-target"]
      assert_response 301
      response.should redirect_to("http://test.host/articles/2004/04/01/search-target")
    end
    ...
    it 'should redirect to article with articles in url_root' do
      ...
      get :redirect, :from => ["articles", "2004", "04", "01", "search-target"]
      assert_response 301
      response.should redirect_to("http://test.host/aaa/articles/bbb/2004/04/01/search-target")
    end
  ...
  describe 'with permalink_format like %title%.html' do
    ...
    it 'should redirect from default URL format' do
      get :redirect, :from => ["2004", "04", "01", "search-target"]
      assert_response 301
      response.should redirect_to("http://myblog.net/search-target.html")
    end
